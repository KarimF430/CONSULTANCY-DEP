                ...
                <div className={styles.section}>
                    <div className={styles.securePayment}>
                        ...
                        <div className={styles.securePaymentInfo}>
                            <span className={styles.secureTitle}>Secure Payment via PayU</span>
                            <span className={styles.secureDesc}>You&apos;ll be redirected to PayU&apos;s secure payment page to complete your payment</span>
                        </div>
                    </div>
                    <div className={styles.paymentBadges}>
                        <span className={styles.badge} style={{ background: '#1a1f71', color: 'white' }}>VISA</span>
                        <span className={styles.badge} style={{ background: '#eb001b', color: 'white' }}>MC</span>
                        <span className={styles.badge} style={{ background: '#097969', color: 'white' }}>RuPay</span>
                        <span className={styles.badge} style={{ background: '#00BAF2', color: 'white' }}>UPI</span>
                        <span className={styles.badge} style={{ background: '#5f259f', color: 'white' }}>PhonePe</span>
                        <span className={styles.badge} style={{ background: '#002970', color: 'white' }}>Paytm</span>
                    </div>
                </div>
